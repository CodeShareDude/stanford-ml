...
J = (sum(sum(-y_bin.*log(H) - (1-y_bin).*log(1-H))))/m;
...
big_delta_2 = delta_3'*a2; 
big_delta_1 = delta_2'*a1;
...
Theta1_grad = (big_delta_1/m) + reg_grad_1;
Theta2_grad = (big_delta_2/m) + reg_grad_2;
